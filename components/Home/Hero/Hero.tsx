...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-[120vh] sm:h-[100vh]">
      {/* overlay */}
      <div className="absolute top-0 left-0 w-full h-full bg-gray-950 opacity-70"></div>
      {/* Video */}
      {/* <video
        src="https://www.cashloansameday.com/assets/images/0510.webm"
        autoPlay
        muted
        loop
        preload="metadata"
      ...
      /> */}
      {/* Images BG  */}
      <div className="w-full h-full relative  bg-gray-800 opacity-40">
      <Image
        src="/hero1.webp"
        alt="Hero background"
        fill
      ...
      <div className="absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex w-[80%] mx-auto justify-center flex-col h-full">
            ...
            <div
              className="text-gray-200 md:text-base font-normal text-left [word-spacing:5px] w-[80%] mx-auto text-sm tracking-wider"
